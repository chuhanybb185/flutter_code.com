...
//当widget第一次插入到widget树时会被调用。对于每一个state对象flutter只会调用该回调一次
  @override
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      print("单次Frame绘制回调"); //渲染只回调一次
    });

    WidgetsBinding.instance.addPersistentFrameCallback((_) {
      print("实时Frame绘制回调"); //渲染的每帧都回调
    });
  }
...
/*
  ...
  */
  ...
  void didChangeDependencies() {
    print('page1 didChangeDependcies......');
